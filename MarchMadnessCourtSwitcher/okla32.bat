...
rem OKLAHOMA32
cd stadiums
move oklahoma32.rpsgl .. > nul 2> stadiums

rem OKLAHOMA32Ren
cd ..
rename "oklahoma32.rpsgl" "stadiumcommontex_932.rpsgl"

rem OKLAHOMA32.1
cd stadiums
move oklahoma32.rpsgl.1 .. > nul 2> stadiums

rem OKLAHOMA32.1Ren
cd ..
rename "oklahoma32.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
