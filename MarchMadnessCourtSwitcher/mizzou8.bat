...
rem MIZZOU8
cd stadiums
move mizzou8.rpsgl .. > nul 2> stadiums

rem MIZZOU8Ren
cd ..
rename "mizzou8.rpsgl" "stadiumcommontex_932.rpsgl"

rem MIZZOU8.1
cd stadiums
move mizzou8.rpsgl.1 .. > nul 2> stadiums

rem MIZZOU8.1Ren
cd ..
rename "mizzou8.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
