...
rem OKLAHOMA64
cd stadiums
move oklahoma64.rpsgl .. > nul 2> stadiums

rem OKLAHOMA64Ren
cd ..
rename "oklahoma64.rpsgl" "stadiumcommontex_932.rpsgl"

rem OKLAHOMA64.1
cd stadiums
move oklahoma64.rpsgl.1 .. > nul 2> stadiums

rem OKLAHOMA64.1Ren
cd ..
rename "oklahoma64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
