...
rem NEWORLEANS64
cd stadiums
move neworleans64.rpsgl .. > nul 2> stadiums

rem NEWORLEANS64Ren
cd ..
rename "neworleans64.rpsgl" "stadiumcommontex_932.rpsgl"

rem NEWORLEANS64.1
cd stadiums
move neworleans64.rpsgl.1 .. > nul 2> stadiums

rem NEWORLEANS64.1Ren
cd ..
rename "neworleans64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
