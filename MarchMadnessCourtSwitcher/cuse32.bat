...
rem SYRACUSE32
cd stadiums
move syracuse32.rpsgl .. > nul 2> stadiums

rem SYRACUSE32Ren
cd ..
rename "syracuse32.rpsgl" "stadiumcommontex_932.rpsgl"

rem SYRACUSE32.1
cd stadiums
move syracuse32.rpsgl.1 .. > nul 2> stadiums

rem SYRACUSE32.1Ren
cd ..
rename "syracuse32.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
