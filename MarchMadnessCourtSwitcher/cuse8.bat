...
rem SYRACUSE8
cd stadiums
move syracuse8.rpsgl .. > nul 2> stadiums

rem SYRACUSE8Ren
cd ..
rename "syracuse8.rpsgl" "stadiumcommontex_932.rpsgl"

rem SYRACUSE8.1
cd stadiums
move syracuse.rpsgl.1 .. > nul 2> stadiums

rem SYRACUSE8.1Ren
cd ..
rename "syracuse8.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
