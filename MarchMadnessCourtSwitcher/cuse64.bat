...
rem SYRACUSE64
cd stadiums
move syracuse64.rpsgl .. > nul 2> stadiums

rem SYRACUSE64Ren
cd ..
rename "syracuse64.rpsgl" "stadiumcommontex_932.rpsgl"

rem SYRACUSE64.1
cd stadiums
move syracuse64.rpsgl.1 .. > nul 2> stadiums

rem SYRACUSE64.1Ren
cd ..
rename "syracuse64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
