...
rem WSU32
cd stadiums
move wsu32.rpsgl .. > nul 2> stadiums

rem WSU32Ren
cd ..
rename "wsu32.rpsgl" "stadiumcommontex_932.rpsgl"

rem WSU32.1
cd stadiums
move wsu32.rpsgl.1 .. > nul 2> stadiums

rem WSU32.1Ren
cd ..
rename "wsu32.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
