...
rem HOUSTON16
cd stadiums
move houston16.rpsgl .. > nul 2> stadiums

rem HOUSTON16Ren
cd ..
rename "houston16.rpsgl" "stadiumcommontex_932.rpsgl"

rem HOUSTON16.1
cd stadiums
move houston16.rpsgl.1 .. > nul 2> stadiums

rem HOUSTON16.1Ren
cd ..
rename "houston16.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
