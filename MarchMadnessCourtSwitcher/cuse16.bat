...
rem SYRACUSE16
cd stadiums
move syracuse16.rpsgl .. > nul 2> stadiums

rem SYRACUSE16Ren
cd ..
rename "syracuse16.rpsgl" "stadiumcommontex_932.rpsgl"

rem SYRACUSE16.1
cd stadiums
move syracuse16.rpsgl.1 .. > nul 2> stadiums

rem SYRACUSE16.1Ren
cd ..
rename "syracuse16.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
