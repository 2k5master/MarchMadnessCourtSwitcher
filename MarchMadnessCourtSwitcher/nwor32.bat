...
rem NEWORLEANS32
cd stadiums
move neworleans32.rpsgl .. > nul 2> stadiums

rem NEWORLEANS32Ren
cd ..
rename "neworleans32.rpsgl" "stadiumcommontex_932.rpsgl"

rem NEWORLEANS32.1
cd stadiums
move neworleans32.rpsgl.1 .. > nul 2> stadiums

rem NEWORLEANS32.1Ren
cd ..
rename "neworleans32.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
