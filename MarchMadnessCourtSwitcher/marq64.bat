...
rem MARQUETTE64
cd stadiums
move marquette64.rpsgl .. > nul 2> stadiums

rem MARQUETTE64Ren
cd ..
rename "marquette64.rpsgl" "stadiumcommontex_932.rpsgl"

rem MARQUETTE64.1
cd stadiums
move marquette64.rpsgl.1 .. > nul 2> stadiums

rem MARQUETTE64.1Ren
cd ..
rename "marquette64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
