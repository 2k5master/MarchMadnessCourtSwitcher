...
rem PROVIDENCE64
cd stadiums
move providence64.rpsgl .. > nul 2> stadiums

rem PROVIDENCE64Ren
cd ..
rename "providence64.rpsgl" "stadiumcommontex_932.rpsgl"

rem PROVIDENCE64.1
cd stadiums
move providence64.rpsgl.1 .. > nul 2> stadiums

rem PROVIDENCE64.1Ren
cd ..
rename "providence64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
