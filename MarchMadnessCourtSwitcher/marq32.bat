...
rem MARQUETTE 32
cd stadiums
move marquette32.rpsgl .. > nul 2> stadiums

rem MARQUETTE32Ren
cd ..
rename "marquette32.rpsgl" "stadiumcommontex_932.rpsgl"

rem MARQUETTE32.1
cd stadiums
move marquette32.rpsgl.1 .. > nul 2> stadiums

rem MARQUETTE32.1Ren
cd ..
rename "marquette32.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
