...
rem WSU64
cd stadiums
move wsu64.rpsgl .. > nul 2> stadiums

rem WSU64Ren
cd ..
rename "wsu64.rpsgl" "stadiumcommontex_932.rpsgl"

rem WSU64.1
cd stadiums
move wsu64.rpsgl.1 .. > nul 2> stadiums

rem WSU64.1Ren
cd ..
rename "wsu64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
