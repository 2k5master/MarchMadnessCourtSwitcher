rem Enable Jacksonville 64
:EnableJacksonville64
@echo off
cls
...
rem JACKSONVILLE64
cd stadiums
move jacksonville64.rpsgl .. > nul 2> stadiums

rem JACKSONVILLE64Ren
cd ..
rename "jacksonville64.rpsgl" "stadiumcommontex_932.rpsgl"

rem JACKSONVILLE64.1
cd stadiums
move jacksonville64.rpsgl.1 .. > nul 2> stadiums

rem JACKSONVILLE64.1Ren
cd ..
rename "jacksonville64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
