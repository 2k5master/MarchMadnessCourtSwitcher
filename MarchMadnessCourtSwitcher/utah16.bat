...
rem UTAH16
cd stadiums
move utah16.rpsgl .. > nul 2> stadiums

rem UTAH16Ren
cd ..
rename "utah16.rpsgl" "stadiumcommontex_932.rpsgl"

rem UTAH16.1
cd stadiums
move utah16.rpsgl.1 .. > nul 2> stadiums

rem UTAH16.1Ren
cd ..
rename "utah16.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
