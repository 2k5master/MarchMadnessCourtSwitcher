...
rem SJSU64
cd stadiums
move sjsu64.rpsgl .. > nul 2> stadiums

rem SJSU64Ren
cd ..
rename "sjsu64.rpsgl" "stadiumcommontex_932.rpsgl"

rem SJSU64.1
cd stadiums
move sjsu64.rpsgl.1 .. > nul 2> stadiums

rem SJSU64.1Ren
cd ..
rename "sjsu64.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
