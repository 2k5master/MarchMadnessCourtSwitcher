rem Enable Jacksonville 32
:EnableJacksonville32
@echo off
cls
...
rem JACKSONVILLE32
cd stadiums
move jacksonville32.rpsgl .. > nul 2> stadiums

rem JACKSONVILLE32Ren
cd ..
rename "jacksonville32.rpsgl" "stadiumcommontex_932.rpsgl"

rem JACKSONVILLE32.1
cd stadiums
move jacksonville32.rpsgl.1 .. > nul 2> stadiums

rem JACKSONVILLE32.1Ren
cd ..
rename "jacksonville32.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
