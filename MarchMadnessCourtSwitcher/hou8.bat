...
rem HOUSTON8
cd stadiums
move houston8.rpsgl .. > nul 2> stadiums

rem HOUSTON8Ren
cd ..
rename "houston8.rpsgl" "stadiumcommontex_932.rpsgl"

rem HOUSTON8.1
cd stadiums
move houston8.rpsgl.1 .. > nul 2> stadiums

rem HOUSTON8.1Ren
cd ..
rename "houston8.rpsgl.1" "stadiumcommontex_932.rpsgl.1"
