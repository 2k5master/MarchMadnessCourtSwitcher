...
rem UTAH8
cd stadiums
move utah8.rpsgl .. > nul 2> stadiums

rem UTAH8Ren
cd ..
rename "utah8.rpsgl" "stadiumcommontex_932.rpsgl"

rem UTAH8.1
cd stadiums
move utah8.rpsgl.1 .. > nul 2> stadiums

rem UTAH8.1Ren
cd ..
rename "utah8.rpsgl.1" "stadiumcommontex_932.rpsgl.1"

goto start

rem Thanks Moth Boy. If you're reading this, dm me and we can talk.